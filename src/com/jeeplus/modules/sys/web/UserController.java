...
public class UserController extends BaseController {
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value={"sys:user:add","sys:user:edit",
			"foodcompanyuser:foodcompanyuser:add","foodcompanyuser:foodcompanyuser:edit",
			"foodorguser:foodorguser:add","foodorguser:foodorguser:edit"},logical=Logical.OR)
