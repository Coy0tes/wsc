...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="memberChongzhi" action="${ctx}/memberchongzhi/memberChongzhi/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="zsjine" htmlEscape="false"    class="form-control "/>
					</td>
		  		</tr>
		 	</tbody>
		</table>
