...
<body class="gray-bg">
	...
	<div class="col-sm-12">
		<div class="pull-left">
	       ...
	       <button class="btn btn-outline btn-primary btn-sm " data-toggle="tooltip" data-placement="left" onclick="refresh()" title="刷新"><i class="glyphicon glyphicon-repeat"></i> 刷新</button>
