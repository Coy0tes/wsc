...
public class FenxiaoYongjin extends DataEntity<FenxiaoYongjin> {
	...
	@ExcelField(title="客户微信Openid", align=2, sort=7)
	...
	@ExcelField(title="客户姓名", align=2, sort=8)
	...
	@ExcelField(title="消费金额", align=2, sort=9)
	...
	@ExcelField(title="发放状态", align=2, sort=10)
