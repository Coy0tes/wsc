...
<body class="gray-bg">
	...
	<div class="col-sm-12">
		<div class="pull-left">
	       ...
	       <button class="btn btn-outline btn-primary btn-sm " data-toggle="tooltip" data-placement="left" onclick="test()" title="测试"><i class="fa fa-check"></i> 测试</button>
	       <button class="btn btn-outline btn-primary btn-sm " data-toggle="tooltip" data-placement="left" onclick="sortOrRefresh()" title="刷新"><i class="glyphicon glyphicon-repeat"></i> 刷新</button>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  width="80px"  class="nowrap">接口名称</th>
				<th  width="60px"  class="nowrap">接口类型</th>
				<th  class="nowrap">请求URL</th>
				<th  width="150px" class="nowrap">请求body</th>
				<th  width="250px" class="nowrap">成功时返回消息</th>
				<th  width="150px" class="nowrap">失败时返回消息</th>
				<th  class="nowrap">备注</th>
				<th  width="150px" class="nowrap">返回参数说明</th>
				<th  width="80px">操作</th>
			</tr>
		</thead>
		<tbody>
