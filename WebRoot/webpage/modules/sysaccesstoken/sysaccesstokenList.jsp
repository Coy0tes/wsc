		...
		<c:forEach items="${page.list}" var="sysaccesstoken">
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="sysaccesstoken:sysaccesstoken:edit">
    					<a href="#" onclick="openDialog('修改token信息', '${ctx}/sysaccesstoken/sysaccesstoken/form?id=${sysaccesstoken.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="sysaccesstoken:sysaccesstoken:del">
